...
function movingBoxes(array){
    ...
    array.forEach(subArray => {
        ...
        let instructions = `Moving ${boxesToMove} box/es from stack ${boxOrigin} to stack ${boxDestination}`;
        ...
        //// puedo hacer de box un mega array, e irle pushando todas las letras una por una
        // luego las voy sacando con shit/unshift y es las voy pusheando al destino
        ...
        while (warehouse.length > 0) {
            box2 = warehouse.pop()
            stackArray[stackDestination-1].push(box2);
        };
